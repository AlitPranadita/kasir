...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                        ...
                        <h3 style="text-align: center">Tambah Data Transaksi</h3>
                        ...
                        <form action="/home/store" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_brg" required="required" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="total_harga" required="required" class="form-control">
                            </div>
    ...
    <script>
        ...
        alertTrigger.addEventListener('click', () => {
            appendAlert('Berhasil Menambah Transaksi', 'success')
        })
        }
    </script>
</body>
