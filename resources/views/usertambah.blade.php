...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                        ...
                        <form action="/home/user/store" method="post">
                            {{ csrf_field() }}
                            <div class="mb-3">
                        ...
                        <div class="mt-2"><a href="/home/user"><button class="btn btn-dark" type="submit" id="liveAlertBtn">Kembali</button></a></div>
                    </div>
                    </div>
                </main>
            </div>
    ...
    <script>
        ...
        alertTrigger.addEventListener('click', () => {
            appendAlert('Berhasil Menambah Data User', 'success')
        })
        }
    </script>
</body>
